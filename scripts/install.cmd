@echo off
:: ============================================
:: Arx Fatalis Head Tracking - Install
:: ============================================
...
:: --- CONFIG BLOCK ---
set "GAME_ID=arx-fatalis"
set "MOD_DISPLAY_NAME=Arx Fatalis Head Tracking"
set "MOD_DLLS=ArxFatalisHeadTracking.asi"
set "MOD_INTERNAL_NAME=ArxFatalisHeadTracking"
...
:: arx.exe is from 2002 and imports none of those: its input is DINPUT.dll and
:: its renderer is DDRAW.dll. dinput.dll is the safer of the two - proxying the
:: renderer on a DirectDraw title puts us in the device creation path for no gain.
set "ASI_LOADER_NAME=dinput.dll"
...
set "MOD_CONTROLS=Controls (nav cluster / chord):&echo   End     / Ctrl+Shift+Y  Toggle tracking&echo   PageUp  / Ctrl+Shift+J  Cycle tracking mode&echo.&echo Arx binds End and Page Up itself, so those presses do both things.&echo Ctrl is magic mode and Shift is stealth mode, so a chord enters both&echo while held. Use whichever set you mind less.&echo There is no recenter key - centre your head in the tracker."
:: --- END CONFIG BLOCK ---
